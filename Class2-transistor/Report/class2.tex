...
\begin{table}[H]
	\begin{tabular}{|cccccc|}
		\hline
		\multicolumn{3}{|c|}{实测值}                                                                                    & \multicolumn{3}{c|}{计算值}                                                                                                                                                                                                  \\ \hline
		\multicolumn{1}{|c|}{$V_G/V$}                                                                                &
		\multicolumn{1}{c|}{$V_S/V$}                                                                                 &
		\multicolumn{1}{c|}{$V_D/V$}                                                                                 &
		\multicolumn{1}{c|}{\begin{tabular}[c]{@{}c@{}}$I_{DQ}=V_S/R_S$\\ /mA\end{tabular}}  &
		\multicolumn{1}{c|}{\begin{tabular}[c]{@{}c@{}}$V_{GSQ}=V_G-V_S/V$\\ /V\end{tabular}} &
		\begin{tabular}[c]{@{}c@{}}$V_{DSQ}=V_D-V_S$\\ /V\end{tabular}                                                                                                                                                                                                                                                    \\ \hline
		\multicolumn{1}{|c|}{2.548}                                                                                  & \multicolumn{1}{c|}{1.026}                                                                                                 & \multicolumn{1}{c|}{6.959} & \multicolumn{1}{c|}{1.004} & \multicolumn{1}{c|}{1.522} & 5.933 \\ \hline
		\multicolumn{1}{|c|}{实测电阻值}                                                                                  & \multicolumn{5}{c|}{$R_{g1}=99.130K\Omega,R_{g2}=99.025K\Omega,R_d=5.021K\Omega, R_{s1}=974.90\Omega,R_{s2}=47.354\Omega$}                                                                                                \\ \hline
	\end{tabular}
	\caption{静态工作点}
	\label{静态工作点}
\end{table}
...
\begin{table}[H]
	\begin{tabular}{|ccc|ccc|c|}
		\hline
		\multicolumn{3}{|c|}{实测值}                                                                                   & \multicolumn{3}{c|}{计算值}   & \multirow{2}{*}{失真类型}                                                                           \\ \cline{1-6}
		\multicolumn{1}{|c|}{$V_G/V$}                                                                               &
		\multicolumn{1}{c|}{$V_S/V$}                                                                                &
		$V_D/V$                                                                                                     &
		\multicolumn{1}{c|}{\begin{tabular}[c]{@{}c@{}}$I_{DQ}=V_S/R_s$\\ /mA\end{tabular}} &
		\multicolumn{1}{c|}{\begin{tabular}[c]{@{}c@{}}$V_{GSQ}=V_G-V_S$\\ /V\end{tabular}}  &
		\begin{tabular}[c]{@{}c@{}}$V_{DSQ}=V_D-V_S$\\ /V\end{tabular}                       &
		\\ \hline
		\multicolumn{1}{|c|}{3.560}                                                                                 & \multicolumn{1}{c|}{1.918} & 2.590                 & \multicolumn{1}{c|}{1.825} & \multicolumn{1}{c|}{1.642} & 0.672  & 饱和失真 \\ \hline
		\multicolumn{1}{|c|}{1.679}                                                                                 & \multicolumn{1}{c|}{0.304} & 10.503                & \multicolumn{1}{c|}{0.289} & \multicolumn{1}{c|}{1.375} & 10.199 & 截止失真 \\ \hline
	\end{tabular}
\end{table}

\begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth]{饱和失真波形图}
	\caption{饱和失真波形图}
	\label{饱和失真波形图}
\end{figure}
